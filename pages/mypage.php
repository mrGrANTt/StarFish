...
<html>
    <?php 
        ...
        if($_GET['id'] == 'boo') {
            ...
            $sel = 'select name, description, logo, upper_image, backgroung_image, contacts, pages.user_id from pages INNER JOIN users on users.id=pages.user_id where pages.id='.$_GET['id'];
//                          0          1        2        3              4             5           6
                            ...
                            <div class="my-page">
                                <div class="upper">
                                    <?php 
                                        ...
                                        echo "<h1 class=\"title\">Hello, I'm - ".$res[0]."</h1>";
                                        get_multy_line($res[1], "<p class=\"description\">", "</p>");
                                    ?>
                                </div>
                                <br/>
                                <div class="body">
                                ...
                                <div class="contacts">
                                    ...
                                    <?php 
                                get_multy_line($res[5], "<span class=\"contact\">", "</span>");
                                    ?>
                                </div>
                            </div>
                        </body>
